...
bool sum_int32_column(int32_t *values, bool *null_mask, idx_t row_count, int64_t *result) {
    // Stub implementation
    return false;
}

bool sum_int64_column(int64_t *values, bool *null_mask, idx_t row_count, int64_t *result) {
    // Stub implementation
    return false;
}

bool sum_float64_column(double *values, bool *null_mask, idx_t row_count, double *result) {
    // Stub implementation
    return false;
}
